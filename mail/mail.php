...
if(isset($_POST['email'])) {
	...
	$transport = Swift_SmtpTransport::newInstance('mail.druhanreunion.com', 25, 'tls' )
	  ->setUsername('info@druhanreunion.com')     
	...
	$message = Swift_Message::newInstance('A message from Druhan Reunion')
	  ->setFrom(array($_POST['email'] => $_POST['name']))
	  ->setTo(array('no-reply@druhanreunion.com' => 'Website Form'))->setBody($messageText);
//                           ^                    ^
